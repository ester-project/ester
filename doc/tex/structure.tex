...
\[ \chi_\rho = \lp\frac{\partial\ln P}{\partial\ln\rho}\rp_T\]
according to \cite{RSI96}. We also introduced

\[ d_P = \lp\frac{\partial\ln\rho}{\partial\ln T}\rp_P = -\chi_t/\chi_\rho\]
From the definitions of \cite{RSI96} and the thermodynamic triangular relation.
