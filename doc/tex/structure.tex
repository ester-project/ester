...
meridional components. The meridional
...
$F_{\rm rad}$ &  $(\theta, idom)$ &  Frad & $\vF_\zeta$ Radiative flux
...
Note that the above table lists all the variables contained in $\vx$ but not
