...
\multicolumn{2}{c|}{Convective} &
\multicolumn{2}{c|}{radiative} \\
\hline
T=1\hspace*{4mm} & T\hspace*{4mm}  & T\hspace*{4mm}  & T\hspace*{4mm}
$\partial$ T & T\hspace*{4mm} $\partial$ T & T\hspace*{4mm}
& T\hspace*{4mm}  & T\hspace*{4mm}  & T\hspace*{4mm} $\partial$ T &
T\hspace*{4mm}  T=T$_s$ \\
\hline
F=0\hspace*{4mm}$\Lambda$ & \hspace*{4mm} $\Lambda$ & \hspace*{4mm}
$\Lambda$ & F\hspace*{4mm}  & $\Lambda$\hspace*{4mm}
& $\Lambda$\hspace*{4mm} & $\Lambda$\hspace*{4mm}  &
$\Lambda$\hspace*{4mm}$\Lambda$ & F\hspace*{4mm} &
$\Lambda$\hspace*{4mm}  \\
\hline
\end{tabular}
...
T\hspace*{4mm} & T\hspace*{4mm} & T\hspace*{4mm} & T\hspace*{4mm}
& T\hspace*{4mm} $\partial$ T& T\hspace*{4mm} $\partial$ T&
T\hspace*{4mm} $\partial$ T & T\hspace*{5mm}  T=T$_s$ \\
\hline
F=0\hfill & $\Lambda$ \hfill & $\Lambda$ \hfill &
$\Lambda$ \hfill & $\Lambda$ \hfill& $\Lambda$ \hfill$\Lambda$ &
F\hfill  & $\Lambda$\hfill & $\Lambda$\hfill & $\Lambda$\hfill  \\
\hline
\end{tabular}
