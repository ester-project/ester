...
T\hspace*{4mm} $\partial$ T & T\hspace*{4mm} &
T\hspace*{4mm}  & T\hspace*{4mm} $\Lambda$ &
T\hspace*{4mm} $\partial$ T & T\hspace*{4mm}  T=T$_s$ \\
\hline
F=0\hspace*{4mm}$\Lambda$ & \hspace*{4mm} $\Lambda$ &
\hspace*{4mm} $\Lambda$   & F\hspace*{4mm}          &
$\Lambda$\hspace*{4mm}    & $\Lambda$\hspace*{4mm}  &
$\Lambda$\hspace*{4mm}    & $\Lambda$\hspace*{4mm}  &
F\hspace*{4mm} & $\Lambda$\hspace*{4mm}  \\
\hline
\end{tabular}
...
T\hspace*{4mm} & T\hspace*{4mm} & T\hspace*{4mm} &
T\hspace*{4mm}$\Lambda$
