...
\end{verbatim} 
Now, we are prepared to compile the main library. The main variables for the compilation are defined in a file named {\verb1 make_%.inc 1}.
The right version should be indicated in the first line of the main makefile {\tt ester/src/Makefile}, for example
\begin{verbatim}
include make_icc.inc
\end{verbatim}
At the moment there are to versions included, {\tt make\_icc.inc} and {\tt make\_gcc.inc},
 for the Intel compiler and the GNU compiler respectively.
