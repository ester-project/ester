...
c**************************************************************************
	...
	SUBROUTINE ppcno12Be(t,ro,comp,dcomp,jac,deriv,fait,
...
c	H1, H2, He3, He4, Li7, Be7, Be9, C12, C13, N14, N15, O16, O17, Ex
...
c	dans ppcno12Be on ajoute Ex, soit nchim+1
...
c	r(15):réaction Be9(p,d)2He4
c	r(16):réaction Be9(a,n)C12
...
c	 ENDDO
	 ...
	 IF(.not.inversible)THEN
	  PRINT*,'ppcno12Be, matrice du calcul des abon. non inversible'
	  PRINT*,'ARRET'
	  STOP
	 ENDIF
...
20	 FORMAT('abondances initiales deduites de X0=',es10.3,
	...
	3 'Z0 = 1-X0-Y0 = Li7+Be7+Be9+C12+C13+N14+N15+O16+O17+Ex',/)	
...
1	 FORMAT('H1:',es10.3,', H2:',es10.3,', He3:',
	...
	4 'O16:',es10.3,', O17:',es10.3,
	5 ', Be9:',es10.3,', Ex :',es10.3)
	 WRITE(2,*)
	 WRITE(2,21)comp(5)/nbz,(comp(6)+comp(13))/nbz,
	1 (comp(7)+comp(8))/nbz,		!C
	2 (comp(9)+comp(10))/nbz,		!N
	3 (comp(11)+comp(12))/nbz,	!O
	4 comp(14)/nbz	!other
21	 FORMAT('rapports en nombre, Li/Z:',es10.3,', Be/Z:',es10.3,
	...
	2 ', O/Z:',es10.3,', Ex/Z:',es10.3,/)
	 ...
	 PRINT*	 
	 WRITE(*,21)comp(5)/nbz,(comp(6)+comp(13))/nbz,
	1 (comp(7)+comp(8))/nbz,		!C
	2 (comp(9)+comp(10))/nbz,		!N
	3 (comp(11)+comp(12))/nbz,	!O
	4 comp(14)/nbz	!other
	 PRINT*,'abondances negligeables:' ; WRITE(*,1)ab_min(1:nchim)
	 PRINT* ; PRINT*,'aucun élément a l''équilibre' ; PRINT*
...
c	 équations d'evolution
	...
	4 +2.d0*r(3)*comp(3)**2+r(16)*comp(13)*comp(4)		!H1
	...
	2 +r(14)*comp(12))*comp(1)-r(16)*comp(13)*comp(4)
	3 +2.d0*r(15)*comp(1)*comp(13)				!He4
	...
	1 +r(16)*comp(13)*comp(4)				!C12
	 ...
	 dcomp(13)=-(r(15)*comp(1)+r(16)*comp(4))*comp(13)	!Be9
	 
c	   Pour vérifications SUM dcomp*nucleo=0

c	 PRINT*,'ppcno12Be, vérifications SUM dcomp*nucleo=0'
c	 WRITE(*,2000)DOT_PRODUCT(dcomp,anuc) ; PAUSE'vérif' 

	 dcomp(14)=-DOT_PRODUCT(dcomp,anuc)/anuc(14) 	!cons. des baryons			
...
c	4 +2.*r(3)*comp(3)**2+r(16)*comp(13)*comp(4)		!H1
	...
	8  +2.d0*drx(3,i)*comp(3)**2
	9  +drx(16,i)*comp(13)*comp(4)		!H1	
	  ENDDO
...
c	1 +r(15)*comp(1)*comp(13)				!H2
	  ...
	  jac(2,1)=2.*r(1)*comp(1)-r(2)*comp(2)+r(15)*comp(13)	!d /H1
...
c	1 +r(4)*comp(4))*comp(3)			!He3
	  ...
	  DO i=1,nchim		!dépendances dues a l'effet d'écran
	   jac(3,i)=jac(3,i)
	1  +drx(2,i)*comp(1)*comp(2)-(2.*drx(3,i)*comp(3)
...
c	2 +r(14)*comp(12))*comp(1)-r(16)*comp(13)*comp(4)
c	3 +2.d0*r(15)*comp(1)*comp(13)				!He4

	  jac(4,1)=2.d0*(r(5)*comp(5)+r(7)*comp(6))
	1 +r(12)*comp(10)+r(14)*comp(12)+2.*r(15)*comp(13)	!d /H1
	  jac(4,3)=2.d0*r(3)*comp(3)-r(4)*comp(4)		!d /He3
	  jac(4,4)=-r(4)*comp(3)-r(16)*comp(13)		!d /He4
	  jac(4,5)=r(5)*comp(1)*2.d0			!d /Li7
	  jac(4,6)=r(7)*comp(1)*2.d0			!d /Be7
	  jac(4,10)=r(12)*comp(1)			!d /N15
	  jac(4,12)=r(14)*comp(1)			!d /O17
	  jac(4,13)=-r(16)*comp(4)+2.d0*r(15)*comp(1)	!d /Be9
	...
	4  -drx(16,i)*comp(13)*comp(4)+2.*drx(15,i)*comp(1)*comp(13)
	  ENDDO
...
c	  équation dcomp(7)	 
c	  dcomp(7)=(-r(8)*comp(7)+r(12)*comp(10))*comp(1)
c	1 +r(16)*comp(13)*comp(4)			!C12

	  jac(7,1)=-r(8)*comp(7)+r(12)*comp(10)		!d /H1
	  jac(7,4)=r(16)*comp(13)			!d /He4
	  jac(7,7)=-r(8)*comp(1)			!d /C12
	  jac(7,10)=r(12)*comp(1)			!d /N15
	  jac(7,13)=r(16)*comp(4)			!d /Be9
...
c	  équation dcomp(13)	 
c	  dcomp(13)=-(r(15)*comp(1)+r(16)*comp(4))*comp(13)	!Be9	 

	  jac(13,1)=-r(15)*comp(13)				!d /H1
	  jac(13,4)=-r(16)*comp(4)				!d /He4	 	 
	  jac(13,13)=-r(15)*comp(1)-r(16)*comp(4)		!d /Be9

	  DO i=1,nchim		!dépendances dues a l'effet d'écran
	   jac(13,i)=jac(13,i)
	1  -(drx(15,i)*comp(1)+drx(16,i)*comp(4))*comp(13)	  
	  ENDDO
...
c	 mue:nombre d'electrons / mole /g = 1/poids mol. moy. par e-
	...
	2 +q(15)*comp(13))*comp(1)+q(16)*comp(13)*comp(4)
	 DO i=2,4
