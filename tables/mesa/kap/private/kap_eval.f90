...
! MK: routine a appeler depuis ESTER   
      ...
      subroutine combine_rad_with_conduction( &
         ...
         ierr = 0
!          print*,"1 combine_rad_with_conduction dlnkap_rad_dlnT =",dlnkap_rad_dlnT
         if (.not. rq% include_electron_conduction) then
            kap = kap_rad
            dlnkap_dlnRho = dlnkap_rad_dlnRho
            dlnkap_dlnT = dlnkap_rad_dlnT
!          print*,"2 combine_rad_with_conduction dlnkap_rad_dlnT =",dlnkap_rad_dlnT
            return
         end if
...
!          print*,"A1 combine_rad_with_conduction dlnkap_ec_dlnT =",dlnkap_ec_dlnT
!          print*,"A1 combine_rad_with_conduction dlnkap_ec_dlnRho =",dlnkap_ec_dlnRho
!          print*,"A1 combine_rad_with_conduction kap_ec =",kap_ec
!          print*,"A1 combine_rad_with_conduction ierr =",ierr
...
!          print*,"A2 combine_rad_with_conduction kap =",kap
...
!          print*,"A3 combine_rad_with_conduction dlnkap_dlnRho =",dlnkap_dlnRho
...
!          print*,"3 combine_rad_with_conduction dlnkap_rad_dlnT =",dlnkap_rad_dlnT
         
         if (is_bad(dlnkap_dlnT)) then
!          print*,"4 combine_rad_with_conduction dlnkap_rad_dlnT =",dlnkap_rad_dlnT
         
            ierr = -1; return
!          print*,"5 combine_rad_with_conduction dlnkap_rad_dlnT =",dlnkap_rad_dlnT
...
!                print*,"6 combine_rad_with_conduction"
