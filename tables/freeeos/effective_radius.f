...
C         nelements+1 and nelements+2 values.
      ...
      include 'constants.h'
      include 'pi_fit.h'
      integer*4 ifpi_fit, nions, nelements, nion(nions+2)
      real*8 bi(nions+2), r_ion3(nions+2), r_neutral(nelements+2)
      integer*4 nelements_local
      parameter (nelements_local = 20)
      integer* 4 ielement, ions
      real*8 rconst, principal2
      save
C      sanity checks
