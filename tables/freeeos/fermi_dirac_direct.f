...
C      is returned.
      ...
      real*8 akindex_local, eta_local, beta_local
      real*8 fermi_fun, dfermi_fun_de, dfermi_fun_db,
     ...
     &  dfermi_fun_deee, dfermi_fun_deeb, dfermi_fun_debb,
     &  fermi_fun0, dfermi_fun0_db, dfermi_fun0_dbb
      real*8 q4err, amp, ampmid
      real*8 answer(9), anslow, ansmid
      integer*4 ifderivative
...
C        overflow.  a4 ~ 1, a2 gets very large
      ...
      real*8 function dfermi_fun_db(x)
C      Derivative wrt beta of integrand of Fermi-Dirac integral.
      ...
      real*8 function dfermi_fun_dee(x)
...
C        overflow.  a4 ~ 1, a2 gets very large
      ...
      real*8 function dfermi_fun_deb(x)
...
C        overflow.  a4 ~ 1, a2 gets very large
      ...
      real*8 function dfermi_fun_dbb(x)
C      Derivative wrt beta, beta of integrand of Fermi-Dirac integral.
      ...
      real*8 function dfermi_fun_deee(x)
...
C        overflow.  a4 ~ 1, a2 gets very large
      ...
      real*8 function dfermi_fun_deeb(x)
...
C        overflow.  a4 ~ 1, a2 gets very large
      ...
      real*8 function dfermi_fun_debb(x)
...
C      in x-eta >> 1 limit where denominator = 1.
      ...
      real*8 function dfermi_fun0_db(x)
C      Derivative wrt beta of integrand of Fermi-Dirac integral
C      in x-eta >> 1 limit where denominator = 1.
      implicit none
      include 'quad4block.h'
     ...
     &  sqrt(1.d0+0.5d0*beta*x)
      ...
      real*8 function dfermi_fun0_dbb(x)
C      Derivative wrt beta, beta of integrand of Fermi-Dirac integral
C      in x-eta >> 1 limit where denominator = 1.
      implicit none
      include 'quad4block.h'
