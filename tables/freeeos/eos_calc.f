...
C      eos_free_calc.
     ...
     &  ifaah2plus, ifaah2
      integer*4 ifexcited, ifsame_zero_abundances, ifnr,
     ...
     &  nextrasum, maxnextrasum, nions_local, nxextrasum
      ...
      real*8  eps(nelements), tl, tc2, bi(nions+2), h2diss,
     ...
     &  r_dv(nions+2), h2, h2f, h2t, h2plus, h2plusf, h2plust
      real*8  g, gf, gt, g_dv(nions_local+2),
     ...
     &  rpower, rpowerh2, rpowerh2plus, constant_sh
      integer*4 iextrasum, jextrasum, iffirst
      data iffirst/1/
