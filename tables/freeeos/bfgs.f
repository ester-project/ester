...
C      x1(n) = x + dx
      ...
      real*8 function bfgs_cubic_minimum(
...
C      within [x_lo, x_hi].
      ...
      implicit none
      real*8 a, fa, fprimea, b, fb, fprimeb, x_lo, x_hi
      real*8 dx, q0, q1, q2, q3, z_lo, z_hi,
...
C          try alternate quadratic solution
     ...
     &        (q2 + z_stationary*q3))
      ...
      real*8 function bfgs_quadratic_minimum(
...
C      0 < tau2 < tau3 <= 0.5 and tau2 <= sigma is advisable
      ...
      logical bracket
      real*8 alpha1, pnorm, dnrm2, pg, ddot, dir,
     &  f0, fprime0, mu,
