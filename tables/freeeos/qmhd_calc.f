...
C         the resulting sum plus partial derivatives wrt tl and x.
      ...
      integer*4 ifpi_fit, iz, nlevel, nx
      real*8 weight_ion, eps_factor, tl, rfactor,
...
C       internal variables
      ...
      real*8 t, rn2, energy, arg, summand, summandt, summandt2,
     &  kn, occupation,
     ...
     &  echarge*echarge*echarge*echarge)
      integer*4 ilevel, nmin_rydberg, nmax, nmin_max
      integer*4 min_nmin_max
...
C       maximum value of mininum principal quantum number
     ...
     &  qstarx2(nx_local,nx_local,nmin_max)
      ...
      real*8 neutral_factor, ionized_factor
