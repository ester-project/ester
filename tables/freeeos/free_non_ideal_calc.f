...
C*******************************************************************************
     ...
     &  free, free_daux)
      ...
      integer*4 ifmodified, ifexcited,
     &  nmax
      real*8 bi(nions+2), t, tl,
     &  eta
      integer nstar
      parameter (nstar = 9)
      real*8 rhostar(nstar), pstar(nstar),
     &  ne, nef
...
C      iextraoff is the number of non-extrasum auxiliary variables
     ...
     &  daux_dv(nions+2, naux), daux_daux(naux, naux)
      ...
      logical 
     &  ifdvzero
      integer*4 index_aux, jindex_aux, n_partial_aux
      real*8 ddv_aux(nions+2,naux), rho,
...
!     &  free_pl, free_plf, free_pl_dv(nions_local+2),
     &  sumpl0, sumpl0f, sumpl0_dv(nions_local+2)
      ...
      integer ifrad
      integer*4 ielement, index_ion, ion
      real*8 fion, fionf, fion_dv(nions+2)
      real*8 free, freef, free_dv(nions_local+2),
     &  free_dauxnew(naux_local), free_daux(n_partial_aux+2)
      real*8 freev, freevf, freev_dv(nions_local+2),
     &  freev_dauxnew(naux_local)
      real*8 ddv_aux_dummy(nions_local+2,naux)
      !temporary
      real*8 free_rad, free_e, free_pl
      save
C      sanity checks.
