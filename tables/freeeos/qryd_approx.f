...
C       that is used in the sum taking account of the convergence criteria.
      implicit none
      include 'constants.h'
      integer*4 nmin, nmin_max, nmax, nb, nmax_reached
      real*8 eps_factor, a, b(nb),
...
C       internal variables:
      ...
      real*8 rn2, arg, summand, summanda, summanda2,
...
C       and approximation
      real*8 lim_sum, lim_approx
      parameter (lim_sum = -1.d-3)
      parameter (lim_approx = -1.d-4)
      real*8 sarg, carg, dsarg, d2sarg,
