...
!  3 -1.34950D+01, 8.59387D+00/
     ...
     &  1.208765D+01,8.31227D+00,-4.94136D+01,5.46883D+01,-2.03073D+01/
      integer*4 nqh2i90_hi
      parameter(nqh2i90_hi = 9)
      real*8 qh2i90_hi(nqh2i90_hi), dqh2i90_hi(nqh2i90_hi-1),
     ...
     &  -1.86763490D+01,-6.74105728D+00,-1.01516624D+00/
      integer*4 nqh2plusi90_hi
      parameter(nqh2plusi90_hi = 8)
      real*8 qh2plusi90_hi(nqh2plusi90_hi),
     ...
     &  1.508621D+00,2.226748D-01/
      integer*4 nqh2st
      parameter(nqh2st = 4)
      real*8 qh2st(nqh2st), dqh2st(nqh2st-1), d2qh2st(nqh2st-2)
      data qh2st/
     &  1.6498d0, -1.6265d0, 0.7472d0, -0.2751d0/
      integer*4 nqh2plusst
      parameter(nqh2plusst = 5)
      real*8 qh2plusst(nqh2plusst), dqh2plusst(nqh2plusst-1),
     &  d2qh2plusst(nqh2plusst-2)
      data qh2plusst/
     &  2.5410d0, -2.4336d0, 1.4979d0, 0.0192d0, -0.7483d0/
      integer*4 nqh2pteh
      parameter (nqh2pteh = 5)
      real*8 qh2pteh(nqh2pteh)
...
C       above range.
      data ifprint/1/
      integer*4 iorder, ifextrapolate, ifextrapolate_dex
      real*8 rmod, t, dtl, ti, tc2, thetal, eh2, poly_sum,
