...
C       sumpl1f and sumpl1t = derivatives of sumpl1 wrt lnf and lnt.
     ...
     &  ion_end(nelements_in), nextrasum, maxnextrasum
      real*8 ionized_hne, ionized_sum0, ionized_sum2,
     &  ionized_extrasum(2),
...
C       Ni+ through Ni28+,
      real*8 bi(nions_in), bi_ref(nions),
     &  ce0(nions), ce(nions),
...
C      12.00000000....  All weights are for the un-ionized element.
     ...
     &  54.9380471d0, 55.9349393d0, 57.9353462d0/
      ...
      real*8 fract(maxionstage), fractf(maxionstage),
     ...
     &  index_element
      real*8 fractmax, sum_full, logsum0, logsum0f,
