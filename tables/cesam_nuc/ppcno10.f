...
c Ex : élément fictif moyenne des éléments # Li  et CNO
...
c	 PRINT*,'ppcno10, vérifications SUM dcomp*nucleo=0'
...
c	3 +r(14)*comp(10))*comp(1)+2.d0*r(3)*comp(2)**2	!H1
	...
	3 -r(7)*comp(1)*dbe7h					!d /H1
	  ...
	  DO i=1,nchim	!dépendances dues a l'effet d'écran et be7/muex
	   jac(1,i)=jac(1,i)
