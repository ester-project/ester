      subroutine masube(drelpr,ic,iex,nd,xd,yd,zd,tp,nxi,nyi,xi,yi,zi,
     *                 ndim,nout,iwk,wk)
...
c
c
c	12.6.1992: creation, derived from ACM, TOMS Alg. 677, masub
c		   included common blocks:jpoint,ipoint for the 
c		   routine pderiv
c
c Last modification: 15.9.1992
c
