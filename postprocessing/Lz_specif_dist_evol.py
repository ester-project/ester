# visualize the distribution of SPECIFIC angular momentum - i.e. per
# unit mass - among the domains
...
def eval_lz_domains(filename):
    ...
    Lz=(a.r*sin(a.th))**2*a.w*a.R**5*Omega_scale*a.rz*a.r**2
...
plt.ylabel('Lz/unit mass / Domain',fontsize=nfont)
plt.title('Evolution of the specific angular momentum per domain')
plt.savefig('Lz_specifi_dom.png', bbox_inches=0)
