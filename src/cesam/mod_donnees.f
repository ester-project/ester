...
c	- les contantes physiques initialisées dans ini_ctes
...
c La signification des variables est décrite au paragraphe F4 de la notice
...
c baratine=.FALSE. permet de dérouter sur les fichiers 
c mon_modele_static, _atmos, _evol
c les informations concernant le déroulement des calculs en ce qui concerne,
c respectivement, la résolution de l'équilibre quasi-statique, la restitution de
c l'atmosphère, l'évolution de la composition chimique, de la vitesse angulaire.
c	LOGICAL, SAVE, PUBLIC :: baratine=.FALSE.
	...
	CHARACTER (len=255), SAVE, PUBLIC :: nom_fich2
