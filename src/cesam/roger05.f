...
c*******************************************************************
	...
	SUBROUTINE roger05(tau,teff,grav,t,dtsdtau,dtsdteff,dtsdg,
	1 ro_ext,dro_grav,dro_teff,f_tau,df_tau,d2f_tau)

c	routine private du module mod_atm
    
c	interface pour la loi T(tau) de R. cayrel avec [Fe/H]=0.5
...
1001	  FORMAT(/,'T(tau,teff,grav) law, roger05, no purely radiative',/,
	1 '[Fe/H]=-0.5 interpolations in Teff and Log g',/,
	2 'artificial extend of the data to Teff = 3500K',/,
	3 '3500K < Teff < 7000K, 1 < Log10(g) < 5, tau_min=1.d-4',/)	  
	 CASE DEFAULT	  
	  WRITE(*,1) ; WRITE(2,1)
1	  FORMAT(/,'loi T(tau,teff,grav), roger05, non purement radiative',
	1 /,'[Fe/H]=-0.5 interpolations en Teff et gravité',/,
	2 'table étendue artificiellement a Teff = 3500K',/,
	3 '3500K < Teff < 7000K, 1 < Log10(g) < 5, tau_min=1.d-4',/)
	 END SELECT	 
	 nom=TRIM(nom_chemin)//'fesh-05.data' ; rad=.FALSE.
	ENDIF
