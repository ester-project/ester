...
c	dans ppcno9ac10 on ajoute Ex, soit nchim+1
...
c	r(16) : réaction C12(a,g)N13
c	r(17) : réaction O16(a,g)Ne20

c	r(18) : C12(C12,g)Mg24			Carbone
c	r(19) : C12(C12,n)Mg23
c	r(20) : C12(C12,p)Na23
c	r(21) : C12(C12,a)Ne20
c	r(22) : C12(C12,2a)O16
c	r(23) : réaction Ne20(a,g)Mg24
...
c----------------------------------------------------------------------
	...
	1 dh2x, denx, dbe7x, dli7x, drt, dro, r, q, dqt, dqo		
...
c	 Ex : élément fictif moyenne des éléments # CNO
	 ...
	 B1: DO i=3,nelem_ini		!a partir de Li=3
...
c	 ENDDO
	 ...
	 IF(.not.inversible)THEN
	  PRINT*,'ppcno3ac10, matrice du calcul des abon. non inversible'
	  PRINT*,'ARRET' ; STOP
	 ENDIF
...
c	 abondances initiales et abondances négligeables
	 ...
	 ab_min=ab_ini*1.d-2 ; nbz=SUM(comp(ihe4+1:nchim))

	 WRITE(2,*)
	 WRITE(2,*)'Réac. thermonucléaires cycles PP, CNO, 3 alpha, C, O'
...
20	 FORMAT('abondances initiales déduites de X0=',es10.3,
	...
	3 'Z0 = 1-X0-Y0 = C12+C13+N14+N15+O16+O17+Ne20+Ex',/)
	 WRITE(2,*) ; WRITE(2,1)ab_ini(1:nchim)
1	 FORMAT('H1:',es10.3,', He3:',es10.3,', He4:',es10.3,
	1 ', C12 :',es10.3,', C13:',es10.3,/,'N14:',es10.3,
	2 ', N15:',es10.3,', O16:',es10.3,', O17:',es10.3,
	3 ', Ne20:',es10.3,/,'Ex :',es10.3)
	 WRITE(2,*)
	 WRITE(2,21)(comp(4)+comp(5))/nbz,(comp(6)+comp(7))/nbz,
	1 (comp(8)+comp(9))/nbz,comp(10)/nbz,comp(11)/nbz
21	 FORMAT('rapports en nombre :',/,'C/Z:',es10.3,', N/Z:',es10.3,
	1 ', O/Z:',es10.3,', Ne20/Z:',es10.3,', Ex/Z:',es10.3,/)
	 WRITE(2,*)'abondances négligeables:' ; WRITE(2,1)ab_min(1:nchim)
	 WRITE(2,*) ; WRITE(2,*)'H2, Li7, Be7 sont pris à l''équilibre'
	 WRITE(2,*)'on utilise une table' ; WRITE(2,*)
	 WRITE(2,*)'évol. temporelle, test de précision sur H et He4'
	 WRITE(2,*)

	 WRITE(*,*)
	 WRITE(*,*)'Réac. thermonucléaires cycles PP, CNO, 3 alpha, C, O'
	...
	1 (comp(8)+comp(9))/nbz,comp(10)/nbz,comp(11)/nbz
	 WRITE(*,*)'abondances négligeables:' ; WRITE(*,1)ab_min(1:nchim)
	 WRITE(*,*) ; WRITE(*,*)'H2, Li7, Be7 sont pris a l''équilibre'
	 WRITE(*,*)'on utilise une table' ; WRITE(*,*)
	 WRITE(*,*)'évolution temporelle, test de précision sur H et He4'
...
c	 équations d'évolution
	...
	2 +r(14)*comp(9))*comp(1)+(2.d0*r(3)*comp(2)-r(4)*comp(3))*comp(2)
	3 +r(21)*comp(4)**2		!H1
	...
	2 +r(16)*comp(4)+r(17)*comp(8)+r(18)*comp(10))*comp(3)
	3 +(r(22)+2.d0*r(23))*comp(4)**2			!He4
	 dcomp(4)=(-r(8)*comp(4)+r(12)*comp(7))*comp(1)
	1 +(r(15)*comp(3)**2-r(16)*comp(4))*comp(3)
	2 -(r(19)+r(20)+r(21)+r(22)+r(23))*comp(4)**2		!C12
	...
	1 -r(17)*comp(8)*comp(3)+r(23)*comp(4)**2 		!O16
	 dcomp(9)=(r(13)*comp(8)-r(14)*comp(9))*comp(1)		 !O17
	 dcomp(10)=(r(17)*comp(8)-r(18)*comp(10))*comp(3)
	1 +r(22)*comp(4)**2					!Ne20

c	   Pour vérifications SUM dcomp*nucleo=0

c	 PRINT*,'ppcno3ac10, vérifications SUM dcomp*nucleo=0'
c	 WRITE(*,2000)DOT_PRODUCT(dcomp,anuc) ; PAUSE'vérif' 

	 dcomp(11)=-DOT_PRODUCT(dcomp,anuc)/anuc(11) 	!conservation des baryons	
...
c	2 +r(14)*comp(9))*comp(1)
c	3 +(2.d0*r(3)*comp(2)-r(4)*comp(3))*comp(2)+r(21)*comp(4)**2!H1
...
c	1 +(r(12)*comp(7)+r(14)*comp(9))*comp(1)-(3.*r(15)*comp(3)**2
c	2 +r(16)*comp(4)+r(17)*comp(8)+r(18)*comp(10))*comp(3)
c	3 +(r(22)+2.d0*r(23))*comp(4)**2			!He4

	  jac(3,1)=r(12)*comp(7)+r(14)*comp(9)			!d /H1
	  jac(3,2)=2.d0*r(3)*comp(2)+r(4)*comp(3)		!d /He3
	  jac(3,3)=r(4)*comp(2)-9.*r(15)*comp(3)**2-r(16)*comp(4)
	1 -r(17)*comp(8)-r(18)*comp(10)				!d /He4
	  jac(3,4)=-r(16)*comp(3)+2.d0*(r(22)+2.d0*r(23))*comp(4) !d /C12
	...
	3  -(3.*drx(15,i)*comp(3)**2
	4  +drx(16,i)*comp(4)+drx(17,i)*comp(8)+drx(18,i)*comp(10))*comp(3)
	5  +(drx(22,i)+2.d0*drx(23,i))*comp(4)**2
	  ENDDO
	 
c	  équation dcomp(4)
c	  dcomp(4)=(-r(8)*comp(4)+r(12)*comp(7))*comp(1)
c	1 +(r(15)*comp(3)**2-r(16)*comp(4))*comp(3)
c	2 -(r(19)+r(20)+r(21)+r(22)+r(23))*comp(4)**2	!C12

	  jac(4,1)=-r(8)*comp(4)+r(12)*comp(7)			!d /H1
	  jac(4,3)=3.*r(15)*comp(3)**2-r(16)*comp(4)		!d /He4	 
	  jac(4,4)=-r(8)*comp(1)-r(16)*comp(3)
	1 -2.d0*(r(19)+r(20)+r(21)+r(22)+r(23))*comp(4)		!d /C12
	...
	3  -(drx(19,i)+drx(20,i)+drx(21,i)
	4  +drx(22,i)+drx(23,i))*comp(4)**2	
	  ENDDO
...
c	  dcomp(7)=(r(10)*comp(6)-(r(11)+r(12))*comp(7))*comp(1) !N15
	  ...
	  DO i=1,nchim		!dépendances dues a l'effet d'écran
	   jac(7,i)=jac(7,i)
	1  +(drx(10,i)*comp(6)-(drx(11,i)
	2  +drx(12,i))*comp(7))*comp(1)
	  ENDDO
	 	 
c	  équation dcomp(8)
c	  dcomp(8)=(r(11)*comp(7)-r(13)*comp(8))*comp(1)
c	1 -r(17)*comp(8)*comp(3)+r(23)*comp(4)**2 		!O16

	  jac(8,1)=r(11)*comp(7)-r(13)*comp(8)		!d /H1
	  jac(8,3)=-r(17)*comp(8)			!d /He4
	  jac(8,4)=2.d0*r(23)*comp(4)			!d /C12	 	 
	...
	2  -drx(17,i)*comp(8)*comp(3)+drx(23,i)*comp(4)**2
	  ENDDO
...
c	  équation dcomp(10)	 		 
c	  dcomp(10)=(r(17)*comp(8)-r(18)*comp(10))*comp(3)+
c	1 +r(22)*comp(4)**2			!Ne20	

	  jac(10,3)=r(17)*comp(8)-r(18)*comp(10)	!d /He4
	  jac(10,4)=2.d0*r(22)*comp(4)			!d /C12
	  jac(10,8)=r(17)*comp(3)			!d /O16
	  jac(10,10)=-r(18)*comp(3)			!d /Ne20 

	  DO i=1,nchim		!dépendances dues a l'effet d'écran
	   jac(10,i)=jac(10,i)+(drx(17,i)*comp(8)
	1  -drx(18,i)*comp(10))*comp(3)+drx(22,i)*comp(4)**2
	  ENDDO
...
c	  jac =0 pour le moment angulaire ou Z
...
c	 PRINT*,'h2,li7,be7' ; WRITE(*,2000)h2,li7,be7
	...
	1 +(q(19)+q(20)+q(21)+q(22)+q(23))*comp(4)**2
	2 +q(18)*comp(3)*comp(10)
	...
	4 +dqt(14)*comp(9))*comp(1)+(dqt(15)*comp(3)**2+dqt(16)*comp(4)
	5 +dqt(17)*comp(8))*comp(3)+dqt(18)*comp(3)*comp(10)
	6 +(q(2)*dh2t+q(5)*dli7t+q(7)*dbe7t)*comp(1)+q(6)*mue*dbe7t
	7 +(dqt(19)+dqt(20)+dqt(21)+dqt(22)+dqt(23))*comp(4)**2
	...
	4 +dqo(14)*comp(9))*comp(1)+(dqo(15)*comp(3)**2+dqo(16)*comp(4)
	5 +dqo(17)*comp(8))*comp(3)+dqo(18)*comp(3)*comp(10)
	6 +(q(2)*dh2ro+q(5)*dli7ro+q(7)*dbe7ro)*comp(1)+q(6)*mue*dbe7ro
	7 +(dqo(19)+dqo(20)+dqo(21)+dqo(22)+dqo(23))*comp(4)**2		
	...
	2 +q(13)*comp(8)+q(14)*comp(9)
	  ...
	  ex(3)=q(4)*comp(2)+3.*q(15)*comp(3)**2+q(16)*comp(4)
	1 +q(17)*comp(8)+r(18)*comp(10)
	  ex(4)=q(8)*comp(1)+q(16)*comp(3)
	1 +2.d0*(q(19)+q(20)+q(21)+q(22)+q(23))*comp(4)
	  ex(5)=q(9)*comp(1)
	  ex(6)=q(10)*comp(1)
	...
	6  +dqx(10,i)*comp(6)+(dqx(11,i)
	7  +dqx(12,i))*comp(7)+dqx(13,i)*comp(8)
	8  +dqx(14,i)*comp(9))*comp(1)
	9  +(dqx(15,i)*comp(3)**2+dqx(16,i)*comp(4)
	1  +dqx(17,i)*comp(8))*comp(3)
	2  +dqx(18,i)*comp(3)*comp(10)
	3  +(dqx(19,i)+dqx(20,i)
	4  +dqx(21,i)+dqx(22,i)
	5  +dqx(23,i))*comp(4)**2
	 ENDDO
	...
	CASE default
	 PRINT*,'ppcno3ac10, fait ne peut valoir que 1, 2, 3 ou 4'
