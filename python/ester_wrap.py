...
class mapping(_object):
    ...
    def draw(self, pfig, A, parity=0):
        return _ester_wrap.mapping_draw(self, pfig, A, parity)

    def drawi0(self, A, sr, st, parity, x, y):
        return _ester_wrap.mapping_drawi0(self, A, sr, st, parity, x, y)

    def drawi(self, pfig, A, sr, st, parity=0):
        return _ester_wrap.mapping_drawi(self, pfig, A, sr, st, parity)

    def drawc(self, pfig, A, ncontours, parity=0):
        return _ester_wrap.mapping_drawc(self, pfig, A, ncontours, parity)

    def drawci(self, pfig, A, sr, st, ncontours, parity=0):
        return _ester_wrap.mapping_drawci(self, pfig, A, sr, st, ncontours, parity)

    def spectrum(self, pfig, y, parity=0):
        return _ester_wrap.mapping_spectrum(self, pfig, y, parity)
...
class star2d(_object):
    ...
    def solve(self, arg2):
        return _ester_wrap.star2d_solve(self, arg2)
    ...
    def drawi(self, arg2, arg3, sr, st, parity=0):
        return _ester_wrap.star2d_drawi(self, arg2, arg3, sr, st, parity)

    def drawc(self, arg2, arg3, ncontours, parity=0):
        return _ester_wrap.star2d_drawc(self, arg2, arg3, ncontours, parity)

    def drawci(self, arg2, arg3, sr, st, ncontours, parity=0):
        return _ester_wrap.star2d_drawci(self, arg2, arg3, sr, st, ncontours, parity)

    def spectrum(self, arg2, arg3, parity=0):
        return _ester_wrap.star2d_spectrum(self, arg2, arg3, parity)
...
class star1d(star2d):
    ...
    def solve(self, arg2):
        return _ester_wrap.star1d_solve(self, arg2)
    ...
    def spectrum(self, *args):
        return _ester_wrap.star1d_spectrum(self, *args)
