...
class doubleArray(_object):
    ...
    __swig_getmethods__["frompointer"] = lambda x: _ester_wrap.doubleArray_frompointer
    if _newclass:
...
class matrix(_object):
    ...
    def __div__(self, *args):
        return _ester_wrap.matrix___div__(self, *args)
    ...
    def __idiv__(self, *args):
        return _ester_wrap.matrix___idiv__(self, *args)
...
class matrix_block_diag(_object):
    ...
    def __div__(self, *args):
        return _ester_wrap.matrix_block_diag___div__(self, *args)
...
class matrix_map(_object):
    ...
    def __idiv__(self, *args):
        return _ester_wrap.matrix_map___idiv__(self, *args)
...
def eos_freeeos(X, Z, T, p, rho, eos):
    return _ester_wrap.eos_freeeos(X, Z, T, p, rho, eos)
eos_freeeos = _ester_wrap.eos_freeeos
...
_ester_wrap.MAP_BONAZZOLA_swigconstant(_ester_wrap)
MAP_BONAZZOLA = _ester_wrap.MAP_BONAZZOLA

_ester_wrap.MAP_LINEAR_swigconstant(_ester_wrap)
...
_ester_wrap.LOG_PRES_swigconstant(_ester_wrap)
...
class star2d(_object):
    ...
    __swig_setmethods__["vangle"] = _ester_wrap.star2d_vangle_set
    __swig_getmethods__["vangle"] = _ester_wrap.star2d_vangle_get
    if _newclass:
        vangle = _swig_property(_ester_wrap.star2d_vangle_get, _ester_wrap.star2d_vangle_set)
    ...
    __swig_setmethods__["reynolds_v"] = _ester_wrap.star2d_reynolds_v_set
    __swig_getmethods__["reynolds_v"] = _ester_wrap.star2d_reynolds_v_get
    if _newclass:
        reynolds_v = _swig_property(_ester_wrap.star2d_reynolds_v_get, _ester_wrap.star2d_reynolds_v_set)
    __swig_setmethods__["reynolds_h"] = _ester_wrap.star2d_reynolds_h_set
    __swig_getmethods__["reynolds_h"] = _ester_wrap.star2d_reynolds_h_get
    if _newclass:
        reynolds_h = _swig_property(_ester_wrap.star2d_reynolds_h_get, _ester_wrap.star2d_reynolds_h_set)
    __swig_setmethods__["visc_v"] = _ester_wrap.star2d_visc_v_set
    __swig_getmethods__["visc_v"] = _ester_wrap.star2d_visc_v_get
    if _newclass:
        visc_v = _swig_property(_ester_wrap.star2d_visc_v_get, _ester_wrap.star2d_visc_v_set)
    __swig_setmethods__["visc_h"] = _ester_wrap.star2d_visc_h_set
    __swig_getmethods__["visc_h"] = _ester_wrap.star2d_visc_h_get
    if _newclass:
        visc_h = _swig_property(_ester_wrap.star2d_visc_h_get, _ester_wrap.star2d_visc_h_set)
    __swig_setmethods__["diffusion_v"] = _ester_wrap.star2d_diffusion_v_set
    __swig_getmethods__["diffusion_v"] = _ester_wrap.star2d_diffusion_v_get
    if _newclass:
        diffusion_v = _swig_property(_ester_wrap.star2d_diffusion_v_get, _ester_wrap.star2d_diffusion_v_set)
    __swig_setmethods__["diffusion_h"] = _ester_wrap.star2d_diffusion_h_set
    __swig_getmethods__["diffusion_h"] = _ester_wrap.star2d_diffusion_h_get
    if _newclass:
        diffusion_h = _swig_property(_ester_wrap.star2d_diffusion_h_get, _ester_wrap.star2d_diffusion_h_set)
    __swig_setmethods__["age"] = _ester_wrap.star2d_age_set
    __swig_getmethods__["age"] = _ester_wrap.star2d_age_get
    if _newclass:
        age = _swig_property(_ester_wrap.star2d_age_get, _ester_wrap.star2d_age_set)
    ...
    __swig_setmethods__["domain_weight"] = _ester_wrap.star2d_domain_weight_set
    __swig_getmethods__["domain_weight"] = _ester_wrap.star2d_domain_weight_get
    if _newclass:
        domain_weight = _swig_property(_ester_wrap.star2d_domain_weight_get, _ester_wrap.star2d_domain_weight_set)
    ...
    def solve_cont(self, arg2):
        return _ester_wrap.star2d_solve_cont(self, arg2)
    ...
    def solve_vangle(self, arg2):
        return _ester_wrap.star2d_solve_vangle(self, arg2)
    ...
    def calc_vangle(self):
        return _ester_wrap.star2d_calc_vangle(self)
    ...
    def count_zones(self, index):
        return _ester_wrap.star2d_count_zones(self, index)

    def get_zone_itfs(self, pzone):
        return _ester_wrap.star2d_get_zone_itfs(self, pzone)

    def add_convective_core(self, pcc, Rcc):
        return _ester_wrap.star2d_add_convective_core(self, pcc, Rcc)

    def remove_convective_core(self):
        return _ester_wrap.star2d_remove_convective_core(self)

    def distribute_domains(self, ndom, pzone, index_new):
        return _ester_wrap.star2d_distribute_domains(self, ndom, pzone, index_new)

    def resample_domain_type(self, ndom_new, index_old, index_new):
        return _ester_wrap.star2d_resample_domain_type(self, ndom_new, index_old, index_new)

    def init_domain_weight(self, domain_type_new):
        return _ester_wrap.star2d_init_domain_weight(self, domain_type_new)

    def get_new_boundaries(self, pzone, Rzone, ndom_zone, weight):
        return _ester_wrap.star2d_get_new_boundaries(self, pzone, Rzone, ndom_zone, weight)

    def find_boundary(self, pif):
        return _ester_wrap.star2d_find_boundary(self, pif)
    ...
    def update_domain_weights(self):
        return _ester_wrap.star2d_update_domain_weights(self)
...
_ester_wrap.RADIATIVE_swigconstant(_ester_wrap)
RADIATIVE = _ester_wrap.RADIATIVE

_ester_wrap.CORE_swigconstant(_ester_wrap)
CORE = _ester_wrap.CORE

_ester_wrap.CONVECTIVE_swigconstant(_ester_wrap)
...
class star_evol(star2d):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["dXdt"] = _ester_wrap.star_evol_dXdt_set
    __swig_getmethods__["dXdt"] = _ester_wrap.star_evol_dXdt_get
    if _newclass:
        dXdt = _swig_property(_ester_wrap.star_evol_dXdt_get, _ester_wrap.star_evol_dXdt_set)
    __swig_setmethods__["drhodt"] = _ester_wrap.star_evol_drhodt_set
    __swig_getmethods__["drhodt"] = _ester_wrap.star_evol_drhodt_get
    if _newclass:
        drhodt = _swig_property(_ester_wrap.star_evol_drhodt_get, _ester_wrap.star_evol_drhodt_set)
    __swig_setmethods__["dpdt"] = _ester_wrap.star_evol_dpdt_set
    __swig_getmethods__["dpdt"] = _ester_wrap.star_evol_dpdt_get
    if _newclass:
        dpdt = _swig_property(_ester_wrap.star_evol_dpdt_get, _ester_wrap.star_evol_dpdt_set)
    __swig_setmethods__["dwdt"] = _ester_wrap.star_evol_dwdt_set
    __swig_getmethods__["dwdt"] = _ester_wrap.star_evol_dwdt_get
    if _newclass:
        dwdt = _swig_property(_ester_wrap.star_evol_dwdt_get, _ester_wrap.star_evol_dwdt_set)
    __swig_setmethods__["dTdt"] = _ester_wrap.star_evol_dTdt_set
    __swig_getmethods__["dTdt"] = _ester_wrap.star_evol_dTdt_get
    if _newclass:
        dTdt = _swig_property(_ester_wrap.star_evol_dTdt_get, _ester_wrap.star_evol_dTdt_set)
    __swig_setmethods__["dphidt"] = _ester_wrap.star_evol_dphidt_set
    __swig_getmethods__["dphidt"] = _ester_wrap.star_evol_dphidt_get
    if _newclass:
        dphidt = _swig_property(_ester_wrap.star_evol_dphidt_get, _ester_wrap.star_evol_dphidt_set)
    ...
    def init_comp(self):
        return _ester_wrap.star_evol_init_comp(self)
    ...
    def init_time_solver(self):
        return _ester_wrap.star_evol_init_time_solver(self)

    def register_variables(self, *args):
        return _ester_wrap.star_evol_register_variables(self, *args)

    def init_step(self, rk):
        return _ester_wrap.star_evol_init_step(self, rk)

    def finish_step(self, rk, state):
        return _ester_wrap.star_evol_finish_step(self, rk, state)

    def check_map(self):
        return _ester_wrap.star_evol_check_map(self)

    def interp(self, red):
        return _ester_wrap.star_evol_interp(self, red)

    def calc_units(self):
        return _ester_wrap.star_evol_calc_units(self)

    def solve_definitions(self, arg2):
        return _ester_wrap.star_evol_solve_definitions(self, arg2)

    def solve_dim(self, arg2):
        return _ester_wrap.star_evol_solve_dim(self, arg2)

    def solve_Omega(self, arg2):
        return _ester_wrap.star_evol_solve_Omega(self, arg2)

    def solve_X(self, arg2):
        return _ester_wrap.star_evol_solve_X(self, arg2)

    def solve_cont(self, arg2):
        return _ester_wrap.star_evol_solve_cont(self, arg2)

    def solve_temp(self, arg2):
        return _ester_wrap.star_evol_solve_temp(self, arg2)

    def solve_mov(self, arg2):
        return _ester_wrap.star_evol_solve_mov(self, arg2)

    def solve(self, *args):
        return _ester_wrap.star_evol_solve(self, *args)

    def reset_time_solver(self, arg2):
        return _ester_wrap.star_evol_reset_time_solver(self, arg2)

    def remove_convective_core(self):
        return _ester_wrap.star_evol_remove_convective_core(self)
...
class plt(_object):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["init"] = lambda x: _ester_wrap.plt_init
    if _newclass:
        init = staticmethod(_ester_wrap.plt_init)
    __swig_getmethods__["subplot"] = lambda x: _ester_wrap.plt_subplot
    if _newclass:
        subplot = staticmethod(_ester_wrap.plt_subplot)
    __swig_getmethods__["plot"] = lambda x: _ester_wrap.plt_plot
    if _newclass:
        plot = staticmethod(_ester_wrap.plt_plot)
    __swig_getmethods__["semilogx"] = lambda x: _ester_wrap.plt_semilogx
    if _newclass:
        semilogx = staticmethod(_ester_wrap.plt_semilogx)
    __swig_getmethods__["semilogy"] = lambda x: _ester_wrap.plt_semilogy
    if _newclass:
        semilogy = staticmethod(_ester_wrap.plt_semilogy)
    __swig_getmethods__["loglog"] = lambda x: _ester_wrap.plt_loglog
    if _newclass:
        loglog = staticmethod(_ester_wrap.plt_loglog)
    __swig_getmethods__["pcolormesh"] = lambda x: _ester_wrap.plt_pcolormesh
    if _newclass:
        pcolormesh = staticmethod(_ester_wrap.plt_pcolormesh)
    __swig_getmethods__["axvline"] = lambda x: _ester_wrap.plt_axvline
    if _newclass:
        axvline = staticmethod(_ester_wrap.plt_axvline)
    __swig_getmethods__["axhline"] = lambda x: _ester_wrap.plt_axhline
    if _newclass:
        axhline = staticmethod(_ester_wrap.plt_axhline)
    __swig_getmethods__["text"] = lambda x: _ester_wrap.plt_text
    if _newclass:
        text = staticmethod(_ester_wrap.plt_text)
    __swig_getmethods__["show"] = lambda x: _ester_wrap.plt_show
    if _newclass:
        show = staticmethod(_ester_wrap.plt_show)
    __swig_getmethods__["ion"] = lambda x: _ester_wrap.plt_ion
    if _newclass:
        ion = staticmethod(_ester_wrap.plt_ion)
    __swig_getmethods__["ioff"] = lambda x: _ester_wrap.plt_ioff
    if _newclass:
        ioff = staticmethod(_ester_wrap.plt_ioff)
    __swig_getmethods__["clf"] = lambda x: _ester_wrap.plt_clf
    if _newclass:
        clf = staticmethod(_ester_wrap.plt_clf)
    __swig_getmethods__["draw"] = lambda x: _ester_wrap.plt_draw
    if _newclass:
        draw = staticmethod(_ester_wrap.plt_draw)
    __swig_getmethods__["legend"] = lambda x: _ester_wrap.plt_legend
    if _newclass:
        legend = staticmethod(_ester_wrap.plt_legend)
    __swig_getmethods__["colorbar"] = lambda x: _ester_wrap.plt_colorbar
    if _newclass:
        colorbar = staticmethod(_ester_wrap.plt_colorbar)
    __swig_getmethods__["close"] = lambda x: _ester_wrap.plt_close
    if _newclass:
        close = staticmethod(_ester_wrap.plt_close)
    __swig_getmethods__["savefig"] = lambda x: _ester_wrap.plt_savefig
    if _newclass:
        savefig = staticmethod(_ester_wrap.plt_savefig)
    __swig_getmethods__["title"] = lambda x: _ester_wrap.plt_title
    if _newclass:
        title = staticmethod(_ester_wrap.plt_title)
    __swig_getmethods__["pause"] = lambda x: _ester_wrap.plt_pause
    if _newclass:
        pause = staticmethod(_ester_wrap.plt_pause)
    __swig_getmethods__["figure"] = lambda x: _ester_wrap.plt_figure
    if _newclass:
        figure = staticmethod(_ester_wrap.plt_figure)
    __swig_getmethods__["axis"] = lambda x: _ester_wrap.plt_axis
    if _newclass:
        axis = staticmethod(_ester_wrap.plt_axis)
    __swig_getmethods__["clim"] = lambda x: _ester_wrap.plt_clim
    if _newclass:
        clim = staticmethod(_ester_wrap.plt_clim)
...
def plt_clim(arg2, arg3):
    return _ester_wrap.plt_clim(arg2, arg3)
plt_clim = _ester_wrap.plt_clim
